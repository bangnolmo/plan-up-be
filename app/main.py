...
from app.domain.login import login_user_router
from app.domain.timeTable import time_table_router, time_table_insert_lectures_router, time_table_lectures_router
...
app.include_router(time_table_lectures_router.router)
app.include_router(time_table_insert_lectures_router.router)
